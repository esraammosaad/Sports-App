...
class SportsServices : SportsServicesProtocol{
    ...
    let url =  "\(Strings.BASEURL)\(sportType)/?APIkey=\(Strings.API_KEY)&met=\(Strings.EVENTS_ENDPOINT)&from=2025-01-01&to=2025-07-30&leagueId=\(leagueID)"
    ...
    let url =  "\(Strings.BASEURL)\(sportType)/?APIkey=\(Strings.API_KEY)&met=\(Strings.TEAMS_ENDPOINT)&leagueId=\(leagueID)"
     ...
     func getCricketLeagueDetails (leagueID : Int,completion : @escaping (CricketEventResponse?) -> Void){
        let url = "\(Strings.BASEURL)\(Strings.CRICKET_ENDPOINT)/?met=\(Strings.EVENTS_ENDPOINT)&APIkey=\(Strings.API_KEY)&from=2025-01-01&to=2026-07-30&leagueId=\(leagueID)"
     ...
     func getTenniseLeagueDetails (countryID : Int,completion : @escaping (TennisEventResponse?) -> Void){
        let url = "\(Strings.BASEURL)\(Strings.TENNIS_ENDPOINT)/?met=\(Strings.EVENTS_ENDPOINT)&APIkey=\(Strings.API_KEY)&from=2025-01-01&to=2026-07-30&countryId=\(countryID)"
